...
export const activate = (context: vscode.ExtensionContext) => {
  ...
  context.subscriptions.push(vscode.languages.registerDocumentSemanticTokensProvider({ language: "spin2" }, new Spin2DocumentSemanticTokensProvider(), legend));
...
class Spin2DocumentSemanticTokensProvider implements vscode.DocumentSemanticTokensProvider {
  ...
  private _tokenString(aToken: IParsedToken, line: string): string {
    ...
    let desiredInterp: string =
      "  -- token=[ln:" + aToken.line + ",ofs:" + aToken.startCharacter + ",len:" + aToken.length + " [" + varName + "](" + aToken.tokenType + "[" + aToken.tokenModifiers + "])]";
